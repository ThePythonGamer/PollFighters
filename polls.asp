          ...
          <%
            ...
            Do while not objRS.EOF
              if objRS("PTitle") <> "" then
                ...
                response.write("<input type='radio' id='Option1' name='Option' value='Option1'>")
                response.write("<label for='Option1'>")
                response.write(objRS("Choice1"))
                response.write("</label><br>")
                response.write("<input type='radio' id='Option2' name='Option' value='Option2'>")
                ...
                response.write("<button type='submit' class='btn btn-success' name='btnvote' value='")
